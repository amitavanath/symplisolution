...
namespace sympliapi.SearchEngineExecutors
{
    public class BingSearchExecutor : ISearchEngineExecutor
    {
        ...
        public BingSearchExecutor(IDistributedCache cache, ISearchResultCacheProvider<SearchResult> searchResultCacheProvider)
        {
            _cache = cache;
        ...
        {
            var cacheKey = searchQueryDto.CompanyURI + searchQueryDto.SearchTerm + SearchEngineNames.Bing;
